...
namespace 大一统{
    [AnyHarmonyPatch(typeof(WorldContainer), "GetCosmicRadiationValueFromFixedTrait", ControlName: new string[] { nameof(大一统.大一统控制台UI.辐星高照) })]
    public class WorldContainer_Patch
    {
        ...
        static void Postfix(WorldContainer __instance,ref int __result)
        {
            ...
            //        // 在此处执行操作，例如修改原始字典
            //        cosmicRadiationFixedTraits[key] *= (int)大一统.大一统控制台UI.Instance.辐星高照;
