...
namespace 大一统{
	[AnyHarmonyPatch(typeof(WorldGen), "RenderOffline", ControlName: new string[] { nameof(大一统.大一统控制台UI.虚空入侵) })]
	public class 虚空入侵
    {
        ...
        public static void SetRandomFifthNodesToSpace(ref WorldGen __instance)
        {
            ...
            // 计算需要更改的节点数量
            int numNodesToChange = (int)(validIndices.Count * 大一统.大一统控制台UI.Instance.虚空入侵程度);
